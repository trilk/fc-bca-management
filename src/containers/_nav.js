...
const _nav = [
  {
    ...
    to: '/dashboard',
    icon: <FontAwesomeIcon icon={faTachometerAlt} style={{ height: 18, width: 18 }} customClasses="c-sidebar-nav-icon" className="mr-4" />,
    badge: {
      color: 'info',
      text: 'NEW',
    }
  },
  {
    ...
    route: '',
    icon: <FontAwesomeIcon icon={faCommentDots} style={{ height: 18, width: 18 }} customClasses="c-sidebar-nav-icon" className="mr-4" />,
    _children: [
      {
        _tag: 'CSidebarNavItem',
...

  {
    ...
    route: '',
    icon: <FontAwesomeIcon icon={faUsers} style={{ height: 18, width: 18 }} customClasses="c-sidebar-nav-icon" className="mr-4" />,
    _children: [
      {
        _tag: 'CSidebarNavItem',
  ...
  },
  {
    ...
    icon: <FontAwesomeIcon icon={faUserShield} style={{ height: 18, width: 18 }} customClasses="c-sidebar-nav-icon" className="mr-4" />,
    to: '/users',
  },
