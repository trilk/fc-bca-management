        ...
        <CCard>
          ...
          <CCardBody>
            <CCarousel>
              <CCarouselInner>
                <CCarouselItem>
                  <img className="d-block w-50" src={slides[0]} alt="slide 1" />
                </CCarouselItem>
                <CCarouselItem>
                  <img className="d-block w-50" src={slides[1]} alt="slide 2" />
                </CCarouselItem>
                <CCarouselItem>
                  <img className="d-block w-50" src={slides[2]} alt="slide 3" />
                </CCarouselItem>
                <CCarouselItem>
                  <img className="d-block w-50" src={slides[0]} alt="slide 4" />
                </CCarouselItem>
                <CCarouselItem>
                  <img className="d-block w-50" src={slides[1]} alt="slide 5" />
                </CCarouselItem>
                <CCarouselItem>
                  <img className="d-block w-50" src={slides[2]} alt="slide 6" />
                </CCarouselItem>
              </CCarouselInner>
