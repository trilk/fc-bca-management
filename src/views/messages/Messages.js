                            ...
                            <CRow>
                                <CCol className="d-flex flex-lg-row flex-md-row flex-sm-row flex-column">
                                    ...
                                    <CCol className="d-flex flex-row p-0">
                                                    ...
                                                    <CForm className="px-3 py-2" >
                                                        <CCol className="p-0 d-flex flex-column pb-3">
                                                            <CLabel htmlFor="exampleDropdownFormEmail1">
                                                                <span style={{ fontSize: 14, fontWeight: 700 }}>Filter Type Messages:</span>
                                                            </CLabel>
                                                            <CCol className="p-0 d-flex flex-column">
                                                                <CFormGroup variant="custom-radio" inline className="pb-2">
                                                                    ...
                                                                    <CLabel variant="custom-checkbox" htmlFor="inline-radio1">
                                                                        <span style={{ fontWeight: 500 }} className="text-muted">Messages</span>
                                                                    </CLabel>
                                                                </CFormGroup>
                                                                <CFormGroup variant="custom-radio" inline className="pb-2">
                                                                    <CInputRadio
                                                                    ...
                                                                    <CLabel variant="custom-checkbox" htmlFor="inline-radio2">
                                                                        <span style={{ fontWeight: 500 }} className="text-muted">Draft</span>
                                                                    </CLabel>
                                                                </CFormGroup>
                                                                <CFormGroup variant="custom-radio" inline>
                                                                    ...
                                                                    />
                                                                    <CLabel variant="custom-checkbox" htmlFor="inline-radio2">
                                                                        <span style={{ fontWeight: 500 }} className="text-muted">Schedule</span>
                                                                    </CLabel>
                                                                </CFormGroup>
                                                            </CCol>
                                                        </CCol>
                                                        <CCol className="p-0" lg="12">
                                                            <CLabel htmlFor="exampleDropdownFormEmail1">
                                                                <span style={{ fontSize: 14, fontWeight: 700 }}>Date Filter:</span>
                                                            </CLabel>
                                                            <CCol className="p-0">
                                                                <CFormGroup>
                                                                    <CLabel htmlFor="exampleDropdownFormEmail1"><span className="text-muted small">Start Date</span></CLabel>
                                                            ...
                                                            <CCol className="p-0 pb-2">
                                                                <CFormGroup>
                                                                    <CLabel htmlFor="exampleDropdownFormEmail1"><span className="text-muted small">End Date</span></CLabel>
                                                                    <CInput className="form-control" id="exampleDropdownFormEmail1" type="date" placeholder="email@example.com" autoComplete="email" />
                                                                </CFormGroup>
                                                            </CCol>
                                                            <CDropdownDivider />
                                                            <CCol className="p-0 py-2">
                                                                <CFormGroup className="mt-2 float-right">
                                                                    <CButton color="ghost" className="mr-2">Reset</CButton>
                                        ...
                                        {/* Start Create */}
                                        <div className="p-0">
                                            <CLink to="/messages/CreateMsg"><CButton size="lg" color="primary"><FontAwesomeIcon icon={faPlusCircle} className="mr-2" /><span>Create Message</span></CButton></CLink>
                                        </div>
                                        {/* End */}
                                    </CCol>
                                </CCol>
