                            ...
                            !isUploaded ? (
                                <>
                                    <CLabel htmlFor="upload-input" className="mb-0 upload-img ">
                                        <FontAwesomeIcon icon={faFileImport} size="3x" className="primary-color ml-3" />
                                        <div className="pl-3">
                                            <h5 className="mb-0 font-weight-bold">{t("msg-image.lb-upload")}</h5>
                                            <small className="text-muted">{t("msg-image.lb-description")}</small>
                                        </div>
                                    </CLabel>
                                    <input
                                ...
                                <div className="previewImage">
                                    ...
                                    <FontAwesomeIcon icon={faTimesCircle} className="close__img" size="2x"
                                        onClick={() => {
                                            setIsUploaded(false)
                                            setImage(null)
                                        }} />
                                    {/* </CTooltip> */}
                                    <CImg id="uploaded-image" src={image} alt="uploaded-img"
