...
const messageData = [
    {id:0, content: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', status: 'Success', delivery: 'success', sentAt: '3/21/21, 3:11:46 pm 18 days, 8 hours ago', sent:'100.000.000', segments: 'Segment 1 team hola',type:'', createDate:convert_day(new Date())},
    {id:0, content: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', status: 'Pending', delivery: 'sending', sentAt: '3/21/21, 3:11:46 pm 18 days, 8 hours ago', sent:'0', segments: 'Segment 2 khu vuc mien nam va nu', createDate:convert_day(new Date())},
    {id:0, content: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', status: 'Pending', delivery: 'pause', sentAt: '3/21/21, 3:11:46 pm 18 days, 8 hours ago', sent:'0', segments: 'Segment 1 team hola', createDate:convert_day(new Date())},
    {id:0, content: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', status: 'Pending', delivery: 'sending', sentAt: '3/21/21, 3:11:46 pm 18 days, 8 hours ago', sent:'0', segments: 'Segment 2 khu vuc mien nam va nu', createDate:convert_day(new Date())},
    {id:0, content: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', status: 'Pending', delivery: 'pause', sentAt: '3/21/21, 3:11:46 pm 18 days, 8 hours ago', sent:'0', segments: 'Segment 1 team hola', createDate:convert_day(new Date())}
