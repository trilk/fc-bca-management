...
const Home = () => {
  ...
  const searchExpenses = async () => {
    fbDb.ExpenseService.getExpenses(
      "vq2022",
      expenseFilter.group,
      eventGroups,
  ...
  return (
    <>
      <CRow>
        <CCol>This is Landing page!</CCol>
      </CRow>
      <CRow>
        <CCol md="6" xs="9">
          <CFormGroup>
      ...
      {expenseData !== null && <ExpenseManagement expenseData={expenseData} />}
    </>
  );
};
